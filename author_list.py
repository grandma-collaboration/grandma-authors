...
{'name': 'T. Culino', 'affiliations': ["Artemis, Observatoire de la Côte d’Azur, Université Côte d’Azur, Boulevard de l'Observatoire, 06304 Nice, France"], 'email': 'thomas.culino@EDU.DEVINCI.FR'},
{'name': 'D. Darson', 'affiliations': ['Ecole Normale Sup ́erieure, CNRS-PSL, Research University, 45, rue d’Ulm 75230 Paris Cedex 5 France'], 'email': ''},
...
{'name': 'F. Dolon', 'affiliations': ['OHP, Observatoire de Haute-Provence, CNRS, Aix Marseille University, Institut Pythéas, St Michel l’Observatoire, France'], 'email': ''},
...
{'name': 'R. Hainich', 'affiliations': ['Institut für Physik und Astronomie, Universität Potsdam, Karl-Liebknecht-Str. 24/25, D-14476 Potsdam, Germany'], 'email': 'rhainich@ASTRO.PHYSIK.UNI-POTSDAM.DE'},
...
{'name': 'T. Hussenot-Desenonges', 'affiliations': ['IJCLab, Univ Paris-Saclay, CNRS/IN2P3, Orsay, France'], 'email': ''},
...
{'name': 'E. E. O. Ishida', 'affiliations': ['LPC, Université Clermont Auvergne, CNES/IN2P3, F-63000, France'], 'email': ''},
...
{'name': 'D. A. Kann', 'affiliations': ["Instituto de Astrof\\'isica de Andaluc\\'ia (IAA-CSIC), Glorieta de la Astronom\\'ia s/n, 18008 Granada, Spain"], 'email': 'andra104@UMN.EDU'},
...
{'name': 'M. Lamoureux', 'affiliations': ["Centre for Cosmology, Particle Physics and Phenomenology - CP3, Universit\\'e catholique de Louvain, B-1348 Louvain-la-Neuve, Belgium"], 'email': ''},
{'name': 'N. Leroy', 'affiliations': ['IJCLab, Univ Paris-Saclay, CNRS/IN2P3, Orsay, France'], 'email': 'leroy@LAL.IN2P3.FR'},
{'name': 'A. Le Van Su', 'affiliations': ['OHP, Observatoire de Haute-Provence, CNRS, Aix Marseille University, Institut Pythéas, St Michel l’Observatoire, France'], 'email': ''},
...
{'name': 'A. Möller', 'affiliations': ['Centre for Astrophysics and Supercomputing, Swinburne University of Technology, Mail Number H29, PO Box 218, 31122 Hawthorn, VIC, Australia', 'ARC Centre of Excellence for Gravitational Wave Discovery (OzGrav), Hawthorn VIC 3122, Australia'], 'email': ''},
...
{'name': 'K. Noonan', 'affiliations': ['University of the Virgin Islands, United States Virgin Islands 00802, USA'], 'email': ''},
...
{'name': 'M. Pilloix', 'affiliations': ["Artemis, Observatoire de la Côte d’Azur, Université Côte d’Azur, Boulevard de l'Observatoire, 06304 Nice, France"], 'email': ''},
{'name': 'T. Pradier', 'affiliations': ['Université de Strasbourg, CNRS, IPHC UMR 7178, F-67000 Strasbourg, France'], 'email': 'thierry.pradier@IPHC.CNRS.FR'},
...
{'name': 'L. Rousselot', 'affiliations': ['Société Astronomique Populaire du Centre ,40 grande rue, 18340 Arçay, France'], 'email': ''},
{'name': 'F. Rünger', 'affiliations': ['Institut für Physik und Astronomie, Universität Potsdam, Karl-Liebknecht-Str. 24/25, D-14476 Potsdam, Germany'], 'email': ''},
...
{'name': 'N. Sasaki', 'affiliations': ['Laboratório Nacional de Astrofísica, R. dos Estados Unidos, 154 - Nações, Itajubá - MG, 37504-364, Brazil'], 'email': ''},
{'name': 'K. Smith', 'affiliations': ['University of the Virgin Islands, United States Virgin Islands 00802, USA'], 'email': ''},
...
{'name': 'D. Turpin', 'affiliations': ["Universit\\'e Paris-Saclay, Université Paris Cité, CEA, CNRS, AIM, 91191, Gif-sur-Yvette, France"], 'email': 'damien.turpin@CEA.FR'},
{'name': 'A. de Ugarte Postigo', 'affiliations': ["Artemis, Observatoire de la Côte d’Azur, Université Côte d’Azur, Boulevard de l'Observatoire, 06304 Nice, France"], 'email': 'adeugartepostigo@GMAIL.COM'},
...
{'name': 'G. de Wasseige', 'affiliations': ['Laboratoire APC, Université de Paris 10, Rue Alice Domon et Léonie Duquet, 75013 Paris, France'], 'email': 'gwenhael.dewasseige@UCLOUVAIN.BE'},
{'name': 'D. Vernet', 'affiliations': ["Observatoire de la Côte d'Azur, CNRS, UMS Galilée, France"], 'email': ''},
