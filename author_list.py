...
authors = [{'author': 'S. Agayeva',
            'affiliation': ['N.Tusi Shamakhy Astrophysical Observatory Azerbaijan National Academy of Sciences, settl.Y. Mammadaliyev, AZ 5626, Shamakhy, Azerbaijan'],
            'email': 'sebnem-agayeva-94@MAIL.RU'},
            {'author': 'V. Aivazyan',
             'affiliation': ['E. Kharadze Georgian National Astrophysical Observatory, Mt.Kanobili, Abastumani, 0301, Adigeni, Georgia', 'Samtskhe-Javakheti  State  University, Rustaveli Str. 113,  Akhaltsikhe, 0080,  Georgia'],
             'email': 'vovaaivazian10@GMAIL.COM'},
            {'author': 'S. Alishov',
             'affiliation': ['N.Tusi Shamakhy astrophysical Observatory Azerbaijan National Academy of Sciences, settl.Mamedaliyev, AZ 5626, Shamakhy, Azerbaijan'],
             'email': 'sebaheddin.ali@GMAIL.COM'},
            {'author': 'M. Almualla'
             'affiliation': ['American University of Sharjah, Physics Department, PO Box 26666, Sharjah, UAE'],
             'email': 'g00074394@aus.edu'},
            {'author': 'C. Andrade',
             'affiliation':["School of Physics and Astronomy, University of Minnesota, Minneapolis, Minnesota 55455, USA"],
             'email': 'andra104@umn.edu'},
            {'author': 'S. Antier',
             'affiliation': ["Artemis, Observatoire de la Côte d’Azur, Université Côte d’Azur, Boulevard de l'Observatoire, 06304 Nice, France"],
             'email': 'sarah.antier@oca.eu'},
            {'author': 'J.-M. Bai',
             'affiliation': ['Yunnan Observatories, Chinese Academy of Sciences, Kunming 650011, Yunnan Province, People’s Republic of China'],
             'email': 'baijm@163.net',},
            {'author': 'A. Baransky',
             'affiliation': ["Astronomical Observatory Taras Shevshenko National University of Kyiv, Observatorna str. 3, Kyiv, 04053, Ukraine"],
             'email': 'abaransky@UKR.NET'},
            {'author': 'S. Basa',
             'affiliation' ["Aix Marseille Univ, CNRS, CNES, LAM, IPhU, Marseille, France"],
             'email': 'stephane.Basa@lam.fr'},
            {'author': 'P. Bendjoya',
             'affiliation': ['Laboratoire J.-L. Lagrange, Universit de Nice Sophia-Antipolis, CNRS, Observatoire de la Cote d’Azur, F-06304 Nice, France'],
             'email': 'bendjoya@oca.eu'},
            {'author': 'Z. Benkhaldoun',
             'affiliation': ["Universit ́e Cadi Ayyad, Facult ́e des Sciences Semlalia, Av. Prince My Abdellah, BP 2390 Marrakesh, Morocco"],
             'email': 'zouhair@uca.ac.ma'},
            {'author': 'S. Beradze',
             'affiliation': ['E. Kharadze Georgian National Astrophysical Observatory, Mt.Kanobili, Abastumani, 0301, Adigeni, Georgia', 'Samtskhe-Javakheti  State  University, Rustaveli Str. 113,  Akhaltsikhe, 0080,  Georgia'],
             'email': 'beradze.sophia@GMAIL.COM'},
            {'author': 'D. Berezin',
             'affiliation': ['ICAMER Observatory of NAS of Ukraine 27 Acad. Zabolotnoho Str., Kyiv, 03143, Ukraine'],
             'email': ''},
            {'author': 'U. Bhardwaj',
