...
{'name': 'B.~Gendre', 'affiliations': ['Department of Physics, University of Western Australia, Crawley WA 6009, Australia', 'Australia ARC Centre of Excellence for Gravitational Wave Discovery {\it (OzGrav)}'], 'email': ''},
...
{'name': '\\fbox{D.~A.~Kann'}, 'affiliations': ["Hessian Research Cluster ELEMENTS, Giersch Science Center, Max-von-Laue-Stra{\\ss}e 12, Goethe University Frankfurt, Campus Riedberg, 60438 Frankfurt am Main, Germany"], 'email': 'ultralonggrbsn@gmail.com', 'orcid': '0000-0003-2902-3583'},
{'name': 'S.~Karpov', 'affiliations': ["CEICO, Institute of Physics of the Czech Academy of Sciences, Na Slovance 1999/2, CZ-182 21, Praha, Czech Republic"]},
...
{'name': 'H.~W.~Peng', 'affiliations': ["Physics Department and Astronomy Department, Tsinghua University, Beijing, 100084, People's Republic of China; Beijing Planetarium, Beijing Academy of Science and Technology, Beijing, 100044, People's Republic of China"], 'email': ''},
